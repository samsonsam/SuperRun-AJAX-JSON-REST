...
class srcDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array())
    {
        ...
        $this->fileMap = array(
            ...
            'App\\Controller\\OverviewController' => __DIR__.'/getOverviewControllerService.php',
            ...
            'console.command.public_alias.App\\Command\\ResetDatabase' => __DIR__.'/getResetDatabaseService.php',
        ...
        include_once $this->targetDirs[3].'/vendor/symfony/asset/UrlPackage.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('50aijNl38T', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ACLUazk6Bc', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? $this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getTwigService()
    {
        ...
        $f = new \Symfony\Component\Asset\VersionStrategy\EmptyVersionStrategy();

        $g = new \Symfony\Component\Asset\Context\RequestStackContext($d, '', false);
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\AssetExtension(new \Symfony\Component\Asset\Packages(new \Symfony\Component\Asset\PathPackage('/assets', $f, $g), array('bootstrap' => new \Symfony\Component\Asset\UrlPackage(array(0 => 'https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta.2'), $f, $g), 'fontawesome' => new \Symfony\Component\Asset\UrlPackage(array(0 => 'https://use.fontawesome.com/releases/v5.0.0/css'), $f, $g), 'jQuery' => new \Symfony\Component\Asset\UrlPackage(array(0 => 'https://code.jquery.com/'), $f, $g), 'popper' => new \Symfony\Component\Asset\UrlPackage(array(0 => 'https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.3/umd'), $f, $g)))));
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MBWBeG5yxw', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? $this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('utXdvHLeyq', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? $this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Eb2RdvEHHo', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? $this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getDebug_Security_Access_DecisionManagerService()
    {
        return $this->privates['debug.security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\TraceableAccessDecisionManager(new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () {
            ...
            yield 2 => ($this->privates['App\Security\RunVoter'] ?? $this->privates['App\Security\RunVoter'] = new \App\Security\RunVoter());
            yield 3 => ($this->privates['App\Security\UserVoter'] ?? $this->privates['App\Security\UserVoter'] = new \App\Security\UserVoter());
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'console.command.ids' => array(
                0 => 'console.command.public_alias.App\\Command\\ResetDatabase',
