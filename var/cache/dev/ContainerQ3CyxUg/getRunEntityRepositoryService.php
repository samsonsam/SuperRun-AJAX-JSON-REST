...
// Returns the private 'App\Repository\RunEntityRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/RunEntityRepository.php';

return $this->privates['App\Repository\RunEntityRepository'] = new \App\Repository\RunEntityRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
