...
$a->setNamespace('sf_orm_default_ed2a9b5774eeb8bf9a5595fcf984d5d6834297a6a36d762470943d8ce88e0ce1');

$b = new \Doctrine\Common\Cache\ArrayCache();
$b->setNamespace('sf_orm_default_ed2a9b5774eeb8bf9a5595fcf984d5d6834297a6a36d762470943d8ce88e0ce1');

$c = new \Doctrine\Common\Cache\ArrayCache();
$c->setNamespace('sf_orm_default_ed2a9b5774eeb8bf9a5595fcf984d5d6834297a6a36d762470943d8ce88e0ce1');

$d = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
$d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(($this->privates['annotations.cached_reader'] ?? $this->getAnnotations_CachedReaderService()), array(0 => ($this->targetDirs[3].'/src/Entity'))), 'App');

$e = new \Doctrine\ORM\Configuration();
$e->setEntityNamespaces(array('App' => 'App'));
...
$e->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\RunEntityRepository' => function () {
    return ($this->privates['App\Repository\RunEntityRepository'] ?? $this->load(__DIR__.'/getRunEntityRepositoryService.php'));
}))));
