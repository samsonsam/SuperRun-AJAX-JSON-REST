...
class srcProdProjectContainer extends Container
{
    ...
    protected function getTwigService()
    {
        ...
        $d = new \Symfony\Component\Asset\Context\RequestStackContext($b, '', false);
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\AssetExtension(new \Symfony\Component\Asset\Packages(new \Symfony\Component\Asset\PathPackage('/assets', $c, $d), array('bootstrap' => new \Symfony\Component\Asset\UrlPackage(array(0 => 'https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta.2'), $c, $d), 'fontawesome' => new \Symfony\Component\Asset\UrlPackage(array(0 => 'https://use.fontawesome.com/releases/v5.0.0/css'), $c, $d), 'jQuery' => new \Symfony\Component\Asset\UrlPackage(array(0 => 'https://code.jquery.com/'), $c, $d), 'popper' => new \Symfony\Component\Asset\UrlPackage(array(0 => 'https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.3/umd'), $c, $d)))));
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('z5Z4KYz3r1', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? $this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()));
    }
